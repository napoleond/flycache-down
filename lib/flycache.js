...
var FlyCacheCore = require('./flycache-core');
var TaskQueue = require('./taskqueue');
var d64 = require('d64');

function FlyCache(dbname) {
console.log("FLYCACHE!!!");
  this._store = new FlyCacheCore(dbname);
  this._queue = new TaskQueue();
}

FlyCache.prototype.sequentialize = function (callback, fun) {
console.log("LKJHG1");
  this._queue.add(fun, callback);
};

FlyCache.prototype.init = function (callback) {
console.log("LKJHG2");
  var self = this;
...
FlyCache.prototype.keys = function (callback) {
console.log("LKJHG3");
  var self = this;
  self.sequentialize(callback, function (callback) {
    self._store.getKeys(function (err, keys) {
...
FlyCache.prototype.setItem = function (key, value, callback) {
...
FlyCache.prototype.getItem = function (key, callback) {
console.log("LKJHG5");
  var self = this;
  self.sequentialize(callback, function (callback) {
...
FlyCache.prototype.removeItem = function (key, callback) {
console.log("LKJHG6");
  var self = this;
  self.sequentialize(callback, function (callback) {
    var idx = utils.sortedIndexOf(self._keys, key);
...
FlyCache.prototype.length = function (callback) {
console.log("LKJHG7");
  var self = this;
  self.sequentialize(callback, function (callback) {
